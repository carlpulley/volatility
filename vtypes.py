...
xpsp2types = { \
  ...
  '_PEB' : [ 0x210, { \
    ...
    'NumberOfHeaps' : [ 0x88, ['unsigned int']], \
    'MaximumNumberOfHeaps' : [ 0x8c, ['unsigned int']], \
  ...
  '_HEAP' : [ 0x588, { \
    'VirtualAllocdBlocks' : [ 0x50, ['pointer', ['_LIST_ENTRY']]], \
    'Segments' : [ 0x58, ['array', 64, ['pointer', ['_HEAP_SEGMENT']]]], \
    'NonDedicatedListLength' : [ 0x16c, ['unsigned int']], \
    'FreeLists' : [ 0x178, ['array', 128, ['pointer', ['_LIST_ENTRY']]]], \
    'FrontEndHeap' : [ 0x580, ['pointer', ['void']]], \
}], \
  '_HEAP_SEGMENT' : [ 0x3c, { \
    'Entry' : [ 0x0, ['_HEAP_ENTRY']], \
    'Signature' : [ 0x8, ['unsigned int']], \
    'Flags' : [ 0xc, ['unsigned int']], \
    'Heap' : [ 0x10, ['pointer', ['_HEAP']]], \
    'LargestUnCommittedRange' : [ 0x14, ['unsigned int']], \
    'BaseAddress' : [ 0x18, ['pointer', ['void']]], \
    'NumberOfPages' : [ 0x1c, ['unsigned int']], \
    'FirstEntry' : [ 0x20, ['pointer', ['_HEAP_ENTRY']]], \
    'LastValidEntry' : [ 0x24, ['pointer', ['_HEAP_ENTRY']]], \
    'NumberOfUnCommittedPages' : [ 0x28, ['unsigned int']], \
    'NumberOfUnCommittedRanges' : [ 0x2c, ['unsigned int']], \
    'UnCommittedRanges' : [ 0x30, ['pointer', ['_HEAP_UNCOMMITTED_RANGE']]], \
