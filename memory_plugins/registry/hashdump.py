...
class hashdump(forensics.commands.command):
	...
	(addr_space, symtab, types) = load_and_identify_image(self.op,
        ...
        samhiveobj = Object("_CMHIVE", self.opts.samhive, addr_space, profile=prof)
        try:
            ...
            if not samhiveobj.Hive.BaseBlock.FileName.endswith("SAM"):
                print "WARN: hive at %x does not appear to be a SAM hive, but continuing anyways" % samhiveobj.offset
        except:
            pass
